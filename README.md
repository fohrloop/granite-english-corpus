...
Script used to create `combined-leipzig.txt`: [create_combined_leipzig.py](scripts/create_combined_leipzig.py)
...
Script used to create `tldr17.txt`: [create_tldr17.py](scripts/create_tldr17.py)
...
Cleanup script which was used to clean the English, Code and Finnish corpora: [clean_up_corpora.py](scripts/clean_up_corpora.py)
